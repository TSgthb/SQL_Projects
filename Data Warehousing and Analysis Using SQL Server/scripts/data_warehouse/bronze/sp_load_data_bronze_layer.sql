/*
===============================================================================
Stored procedure for loading data in the tables of bronze layer 
===============================================================================
Script Purpose:
1. This stored procedure loads data into the 'bronze' schema from external CSV files. 
2. It performs the following actions:
  a. Truncates the bronze tables before loading data.
  b. Uses the `BULK INSERT` command to load data from csv Files to bronze tables.
